...
class Model(nn.Module):
    ...
    def forward(self, images, future_images):
        ...
        for _ in range(2):
            ...
            score_real = self.discriminator(real_sequence)
        ...
        for g_seq in generated_sequence:
            ...
            # concatenated_outputs = self.discriminator(concatenated_inputs)
            # score_real, score_generated = torch.split(concatenated_outputs, 1, dim=0)
            score_generated = self.discriminator(g_seq)
...
if __name__ == '__main__':
    # df = pd.read_csv('uk190624-256.csv').fillna(0).iloc[:, 3:].T.values
    ...
    train_set = inp[:slice]
    # slice = 288 * 6 + 218
    # train_set180101 = inp[:288]
    # train_set180102 = inp[288:288 * 2]
    # train_set190628 = inp[288 * 2:288 * 3]
    # train_set190629 = inp[288 * 3:288 * 4]
    # train_set190630 = inp[288 * 4:288 * 5]
    # train_set220101 = inp[288 * 5:288 * 6]
    # train_set190624 = inp[288 * 6:slice]
    test_set = inp[slice - n_steps:]

    # train_x180101, train_y180101 = split_sequence(train_set180101, n_steps, multi)
    # train_x180102, train_y180102 = split_sequence(train_set180102, n_steps, multi)
    # train_x190628, train_y190628 = split_sequence(train_set190628, n_steps, multi)
    # train_x190629, train_y190629 = split_sequence(train_set190629, n_steps, multi)
    # train_x190630, train_y190630 = split_sequence(train_set190630, n_steps, multi)
    # train_x220101, train_y220101 = split_sequence(train_set220101, n_steps, multi)
    # train_x190624, train_y190624 = split_sequence(train_set190624, n_steps, multi)
    # train_x = train_x180101 + train_x180102 + train_x190628 + train_x190629 + train_x190630 + train_x220101 + train_x190624
    # train_y = train_y180101 + train_y180102 + train_y190628 + train_y190629 + train_y190630 + train_y220101 + train_y190624
    ...
    for i in range(epochs):
        ...
        Test()
        gc.collect()
    torch.save(model, 'uk7ganrccld.pt')